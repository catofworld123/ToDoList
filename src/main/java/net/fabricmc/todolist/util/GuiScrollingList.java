package net.fabricmc.todolist.util;
...
public abstract class GuiScrollingList
{
    ...
    private boolean isSelectOverlayOn = true;
    private boolean field_27262_q;
    private int field_27261_r;
    private int toptinkernumber = 0;
    private int bottomtinkernumber = 0;

    public GuiScrollingList(Minecraft client, int width, int height, int top, int bottom, int left, int entryHeight,int toptinkernumber,int bottomtinkernumber)
    {
        this.client = client;
        ...
        this.toptinkernumber = toptinkernumber;
        this.bottomtinkernumber = bottomtinkernumber;
    }

    public void setHasSelectedOverlay(boolean x)
    {
        this.isSelectOverlayOn = x;
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float p_22243_3_)
    {
        ...
        int boxRightTrue = scrollBarXStart -1;
        int var10;
        int var11;
        int var13;
        int var19;
        ...
        for (var11 = 0; var11 < listLength; ++var11)
        {
            ...
            if (var19 <= this.bottom-bottomtinkernumber && var19 + var13 >= this.top+toptinkernumber)
            {
                if (this.isSelectOverlayOn && this.isSelected(var11))
                {
                    var14 = boxLeft;
                    int var15 = boxRightTrue;
                    GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
    ...
    private static void glBlendFunc(int p_148821_0_, int p_148821_1_, int p_148821_2_, int p_148821_3_)
    {
        ...
        boolean openGL14 = contextcapabilities.OpenGL14 || contextcapabilities.GL_EXT_blend_func_separate;
        boolean field_153211_u = contextcapabilities.GL_EXT_blend_func_separate && !contextcapabilities.OpenGL14;
        if (openGL14)
        {
            if (field_153211_u)
            {
